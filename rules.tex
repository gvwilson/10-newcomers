...
but it is only in recent years that researchers have begun to pay serious attention to
what their peers have learned about why some communities thrive and others fail.
Knowing just a few key facts can help communities attract more contributors,
help them be more productive,
and retain them.
This paper presents ten rules that members of open source and open science communtiies can apply immediately
and explains why they work.

\section*{Introduction}

According to Wenger~\cite{wenger1999}, a \emph{community of practice} has three key characteristics:
...
Every thriving open source software project,
and every healthy open science research project,
is necessarily a community of practice.
In order to be productive in the long term,
such projects must attract new participants,
help them find and create value,
and retain them.
The ten evidence-based rules described below can help such projects achieve these goals.
...
We can take as a given that people's time has value,
and that a core tenet of free and open source software is that
people should not need to spend valuable time and effort re-solving solved problems.

If you watch a wheelchair ramp or a button that opens a heavy door long enough,
you'll notice that the people using them are nearly never their intended audience;
it's never infirm or in a wheelchair.
It's always somebody with a stroller or one too many bags of groceries or just their hands full:
it's somebody doing something difficult, who'd like it to be just a little bit easier. 

It's worth looking carefully at the process of getting involved in your project
through that same lens of accessibility.
How much of contributing to your project is difficult because it's inherently difficult,
and how much of it is difficult only because you haven't taken the time to make it easy? 

Unnecessary complexity is always a barrier to participation,
but getting a working development environment set up
is a critical moment in your relationship with a new contributor
and there is a lot to be gained from automating as much of this process as possible
and thoroughly documenting whatever you can't. 

Much of this work is self-interested.
None of us are further than one sprained ankle away
from desperately wanting that wheelchair ramp to be there;
likewise someday a drive failure will force a reinstall on you at the absolute least convenient time.
Cannier veterans of this space can attest to the fact that
you can't have reproducible builds
without your dependencies and tooling checked into version control with your code,
a lesson that---like having backups and not running everything as root---we seem to insist on learning the hard way.
(And let's put aside the cold, hard fact that
if you can't get from a bare OS to a working build environment in a few simple steps
it's guaranteed you don't know what your build environment actually is.)
This is a new contributor's first impressions of participating in your project,
the moment they decide to go from ``I want to help''
to ``I'm set up to help''
to ``I'm helping''.
You are making it clear how much your project values the time and effort of new participants
by the work you've put into making that experience painless.
